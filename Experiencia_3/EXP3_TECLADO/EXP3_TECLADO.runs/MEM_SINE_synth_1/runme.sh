...
HD_PWD='C:/Users/Francisco/Desktop/LAB ANALOGICO/Exp3/EXP3_TECLADO/EXP3_TECLADO.runs/MEM_SINE_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MEM_SINE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MEM_SINE.tcl
