...
#
# Generated by export_simulation on Fri May 10 16:57:38 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './MEM_SINE.sh' script.

./MEM_SINE.sh -reset_run
...
./MEM_SINE.sh -noclean_files

For more information on the script, please type './MEM_SINE.sh -help'.
