...
HD_PWD='C:/Users/Francisco/Desktop/LAB ANALOGICO/Exp2/Proyecto_Exp2_SINSUNDADA/Proyecto_Exp2_SINSUNDADA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Divisordeclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Divisordeclk.tcl
